...
const FILE: any = readFileSync("./src/Dark Crayon.sublime-color-scheme");
...
writeFileSync("./dist/Dark Crayon.sublime-color-scheme", JSON.stringify(BUILD_COLOR_SCHEME, null, "\t"), "utf8");
